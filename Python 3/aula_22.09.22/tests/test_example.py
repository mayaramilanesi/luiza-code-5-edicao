...
# Método que recebe um número inteiro:
      # Quando o número for múltiplo de 3 ele vai retornar "Múltiplo de 3"
      # Quando o número for múltiplo de 5 ele vai retornar "Múltiplo de 5"
...
def test_valida_mutiplos_deve_escrever_caiu_no_metodo(capsys):
